...
if __name__ == "__main__":
    ...
    for oriFile in list_orifile:
        ...
        cmd = "./file/tmc13v14_r --mode=0 -c ./file/redandblack.cfg --uncompressedDataPath=./temp/tmc/p.ply --compressedStreamPath=./temp/tmc/tmc.bin --mergeDuplicatedPoints=1 --positionBaseQp=4 --positionQuantizationScale=" + str(
            qstmc)
